...
class gcs_task_assign{
    ...
    void Get_next_point_to_go_0()
    {
        ...
        if(  (point_temp_0-position_pair["/jurong"].position).norm()<0.5 || position_pair["/jurong"].position.z()>point_temp_0.z() )//一个box扫描完毕
        {
            ...
            if(target_box_0+1<box_index_0.size())//~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            {
                ...
                height_index_0 = 0;
                cout<<"换盒"<<box_index_0[target_box_0]<<endl;
            }
            else
            {
                return;
    ...
    void Get_next_point_to_go_1()
    {
        ...
        if(  std::abs(position_pair["/raffles"].position.z() - point_temp_1.z())<0.5  )//一个box扫描完毕
        {
